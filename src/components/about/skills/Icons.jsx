...
function Icons() {
  ...
  const handleMouseMove = (event)=>{
        ...
        const y = event.pageY/30-30
        // console.log(x,y)
        if(react.current&&tail.current&&js.current&&css.current&&html.current&&node.current&&window.innerWidth>=768){
 
           react.current.style.transform = `rotateX(-${y}deg) rotateY(${x}deg)`
           ...
           js.current.style.transform = `rotateX(-${y}deg) rotateY(${x}deg)`
  ...
  return (
    <>
                    ...
                    {/* react icon */}
                    <div className="absolute h-[20%] w-[20%] translate-x-[40%] translate-y-[10%]">
                        <svg 
                            ref={react}
                            viewBox="0 0 34 32"
                            fill="#00d8ff"
                    ...
                    {/* tailwind icon */}
                    <div className="absolute h-[20%] w-[20%] translate-x-[200%] translate-y-[30%]">
                            <svg
                            ref={tail}
                            viewBox="0 0 24 24"
                            fill="#00b6d6"
                    ...
                    {/* javascript */}
                    <div className="absolute h-[20%] w-[20%] translate-x-[260%] translate-y-[180%]">
                        <svg
                            ref={js}
                            className="w-full h-full transition-all ease-linear "
                            viewBox="0 0 512 512"
                    ...
                    {/* css */}
                    <div className="absolute h-[20%] w-[20%] translate-x-[340%] translate-y-[40%]">
                        <svg
                        ref={css}
                        className="w-full h-full transition-all ease-linear "
                        viewBox="0 0 24 24"
                    ...
                    {/* html */}
                    <div className="absolute h-[20%] w-[20%] translate-x-[80%] translate-y-[210%]">
                        <svg
                            ref={html}
                    ...
                    {/* node js */}
                    <div className="absolute h-[20%] w-[20%] translate-x-[240%] translate-y-[310%]">
                        <svg
                            ref={node}
                            viewBox="0 0 24 24"
                            fill="#90c63d"
